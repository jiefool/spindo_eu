  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="col-md-3">
          <img src="<?php bloginfo('template_url'); ?>/images/esileht_logo.png"/>
        </div>
        <div class="col-md-6">
          <h1 style="font-family:'Shadows Into Light">pick, join and win the price you want!</h1>
        </div>
        <div class="col-md-3">
         <a href=""><h1 style="float:left;margin-right:10px"><i class="fa fa-facebook-official"></h1></i></a>
         <a href=""><h1 style="float:left;margin-right:10px"><i class="fa fa-twitter"></h1></i></a>
         <a href=""><h1 style="float:left;margin-right:10px"><i class="fa fa-pinterest"></h1></i></a>
        </div>
      </div>
    </div>
  </div>
