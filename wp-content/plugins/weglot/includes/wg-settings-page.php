...
color : blue!important;
}', 'weglot' ); ?>"><?php echo esc_attr( get_option('override_css') ); ?></textarea></td>
			</tr>
		</table>
		...
		<h3 style="border-bottom:1px solid #c0c0c0;padding-bottom:10px;max-width:800px;margin-top:40px;"><?php echo __( 'Filter URL', 'weglot' )." ".__( '(Optional)', 'weglot' );; ?></h3>
		<p><?php _e( 'By default, every page can be translated. You can exclude URL here.', 'weglot' ); ?></p>
		<table class="form-table">
			<tr valign="top">
			...
			<td><textarea type="text" rows = 5 cols = 30 name="exclude_url" placeholder=""><?php echo esc_attr( get_option('exclude_url') ); ?></textarea></td>
			</tr>
		</table>
