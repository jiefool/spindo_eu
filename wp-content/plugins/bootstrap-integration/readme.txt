...
For those templates which don't came with bootstrap libraries, this plugin integrate the style and the script (version 3.3.5) with your wordpress installation. 
